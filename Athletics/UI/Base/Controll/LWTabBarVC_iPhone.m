...
//     UITabBarItem *item4 = [[UITabBarItem alloc]initWithTitle:@"我的" image:[UIImage imageNamed:@"iconfont-bofang(1).png"] tag:103];
    ...
    _firstItem = [[UITabBarItem alloc] initWithTitle:@"资讯" image:[UIImage imageNamed:@"tab_news_nor"] selectedImage:[UIImage imageNamed:@"tab_news_highlight"]];
    _secondItem = [[UITabBarItem alloc] initWithTitle:@"社区" image:[UIImage imageNamed:@"tab_community_nor"] selectedImage:[UIImage imageNamed:@"tab_community_highlight"]];
    _thirdItem = [[UITabBarItem alloc] initWithTitle:@"赛事" image:[UIImage imageNamed:@"tab_live_nor"] selectedImage:[UIImage imageNamed:@"tab_live_highlight"]];
    _fourthItem = [[UITabBarItem alloc] initWithTitle:@"视频" image:[UIImage imageNamed:@"tab_schedule_nor"] selectedImage:[UIImage imageNamed:@"tab_schedule_highlight"]];
    _fifthItem = [[UITabBarItem alloc] initWithTitle:@"我的" image:[UIImage imageNamed:@"tab_me_nor"] selectedImage:[UIImage imageNamed:@"tab_me_highlight"]];
